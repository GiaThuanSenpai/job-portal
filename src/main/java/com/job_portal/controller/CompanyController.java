...
public class CompanyController {
	...
	public ResponseEntity<String> updateCompany(@RequestHeader("Authorization") String jwt, @RequestBody CompanyDTO company) {
		...
		try {
			...
			boolean isUpdated = companyService.updateCompany(newCompany, reqCompany.get().getCompanyId(), company.getIndustryId(), company.getCityId());
			if (isUpdated) {
